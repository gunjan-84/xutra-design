...
const BrokerBadge = ({ brokerId, brokers }) => {
  ...
  if (b.logo && !errored) {
    return (
      <img src={b.logo} alt={b.name} title={b.name}
              ...
              <Reorderable key={id} id={id}
                ...
                {id === "summary" && (
                  <section style={{
                    ...
                    <div style={{ position: "absolute", top: 10, right: 10, color: "var(--color-on-surface-variant)" }}><DragHandle /></div>

                    <p className="font-label-caps" style={{ margin: 0, color: "var(--color-on-surface-variant)" }}>
                      Current Value
                    </p>
                    <p className="font-data-mono" style={{ fontSize: 30, fontWeight: 700, margin: "4px 0 0", letterSpacing: "-0.01em" }}>
                      {fmtP(hCurrent)}
                    </p>
                    ...
                    <div style={{
                      ...
                      <span style={{ fontSize: 11 }} aria-hidden>{hUp ? "▲" : "▼"}</span>
                      <span className="font-data-mono" style={{ fontSize: 15, fontWeight: 600 }}>
                        {hUp ? "+" : ""}{fmtP(hPnl)}
                      </span>
                    ...
                    <div style={{
                      ...
                      borderTop: "1px solid color-mix(in oklab, var(--color-on-surface) 8%, transparent)",
                      display: "flex", alignItems: "center", gap: 6,
                      fontSize: 12, color: "var(--color-on-surface-variant)",
                    }}>
                      <span>Invested</span>
                      <span className="font-data-mono" style={{ color: "var(--color-on-surface)", fontWeight: 500 }}>
                        {fmtP(hInvested)}
                      </span>
                    </div>
                  </section>
                ...
                {id === "summary" && (
                  <section style={{
                    ...
                    <div style={{
                      ...
                      <span style={{ fontSize: 11 }} aria-hidden>{pUp ? "▲" : "▼"}</span>
                      <span className="font-data-mono" style={{ fontSize: 15, fontWeight: 600 }}>
                        {pUp ? "+" : ""}{fmtP(pPnl)}
                      </span>
                      <span style={{ fontSize: 13, fontWeight: 600, opacity: 0.85 }}>
