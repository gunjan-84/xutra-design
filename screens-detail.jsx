                  ...
                  <button key={b.id} onClick={() => setOrderBrokerId(b.id)}
                    ...
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", lineHeight: 1.2 }}>
                      ...
                      <span style={{ fontSize: 10, color: "var(--color-on-surface-variant)" }}>
                        {ctx.feedBroker?.id === b.id ? "Live feed" : "Connected"}
                      </span>
                    </div>
                    {active && (
                      <span style={{
      ...
      <footer className="trade-footer">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 12 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
            <span className="font-label-caps" style={{ color: "var(--color-on-surface-variant)" }}>Available</span>
            <span className="font-data-mono" style={{ color: "var(--color-secondary)" }}>1,42,084.00</span>
          </div>
        </div>
        {orderBroker && (
          <div style={{
